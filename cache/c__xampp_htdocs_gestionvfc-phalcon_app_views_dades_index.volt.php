...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"></head><body><div class="row">
    <div class="col-md-6 col-md-offset-3">
        ...
        <form action="<?= $this->url->get('dades/guarda/') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="cicle" name="cicle" required <?= (isset($alta) ? '' : 'readonly') ?>>
