...
<head>
  ...
  <link rel="stylesheet" href="/gestionvfc-Phalcon/public/adminlte/dist/css/skins/skin-purple.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?= $this->url->get('comandes') ?>"><i class="fa fa-file-text-o"></i> <span>Comandes</span></a></li>
        ...
        <li><a href="#"><i class="fa fa-list"></i> <span>Compres</span></a></li>
        <li><a href="#"><i class="fa fa-cc-visa"></i> <span>Liquidacions</span></a></li>
        <li class="header">CONTROL ECONÒMIC</li>
        <li><a href="#"><i class="fa  fa-euro"></i> <span>Caixa</span></a></li>
        <li><a href="#"><i class="fa fa-building-o"></i> <span>Banc</span></a></li>
        <li class="header">CONFIGURACIÓ</li>
        <li><a href="#"><i class="fa fa-plane"></i> <span>Dades viatge</span></a></li>
        <li><a href="#"><i class="fa fa-calculator"></i> <span>Cost</span></a></li>
        <li><a href="#"><i class="fa fa-th"></i> <span>Cicles</span></a></li>
