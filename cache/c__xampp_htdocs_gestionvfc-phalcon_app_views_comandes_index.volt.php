            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <?php $total = 0; ?>
                        <?php foreach ($arrayComandes as $comanda) { ?>
                            ...
                            <tr >
                                ...
                                <td style="margin: 0px;padding: 2px;">
                                    <a href="<?= $this->url->get('comandes/ver/' . $comanda->numero) ?>" class="btn btn-primary" ><i class="fa fa-eye"></i></a>
                                    <a href="<?= $this->url->get('comandes/modificarcomanda/' . $comanda->numero) ?>" class="btn btn-info" ><i class="fa fa-cogs"></i></a>
                                </td>
                            </tr>
